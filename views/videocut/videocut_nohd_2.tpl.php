...
<body style="margin:0px 0px 0px 0px;">
        ...
        <form action="<?=$this->tid?>" method="POST" id="copy">   
                <table border="0">
                    ...
                    <tr>
                        <td style='margin:0 auto;text-align:center'><input type="radio" size="1" name="check"></td><td style='margin:0 auto;text-align:center'><input type="radio" size="1" name="check"></td>                
                    </tr>
                    <tr>
